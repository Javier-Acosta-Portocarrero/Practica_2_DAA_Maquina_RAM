...
// Fecha: 17/02/2024
// Archivo jzero_instruction.cc: fichero de definicion.
// Contiene la definicion de la clase JzeroInstruction.

#include "jzero_instruction.h"
...
void JzeroInstruction::Execute(DataMemory& data, InputTape& input_tape, OutputTape& output_tape, const ProgramMemory& instructions) {
