...
// Fecha: 17/02/2024
// Archivo halt_instruction.h: fichero de declaracion.
// Contiene la declaracion de la clase HaltInstruction.

#ifndef HALT_INSTRUCTION_H_
#define HALT_INSTRUCTION_H_
